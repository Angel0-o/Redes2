...
public class ListaObjetos implements Serializable{
    ...
    public ListaObjetos(int tipoC, int tamano, Usuario[] o1)
    {
    ...
    public LinkedList getObjetos() {
        return objetos;
    }

    public void setObjetos(LinkedList objetos) {
...
class ListaCasa implements Serializable
{
    static final long serialVersionUID = 42L;
    ...
    public ListaCasa(int tamano, ListaObjetos[] o1)
    {
        this.cantidad = tamano;
        for(int i=0; i<tamano;i++)
            listaObjetos.add(o1[i]);
    }
    ...
    public void imprimeListaObjeto(){
        ListIterator li = listaObjetos.listIterator();
        ListaObjetos o1;
        
        System.out.println("\nListaObjetos["+listaObjetos.size()+"]:");
        while(li.hasNext()){
            o1 = (ListaObjetos) li.next();
            o1.imprimeObjeto();
        }
    }
}
